...
This fork has been modified from the original work done by JamieDStewart. The goal of the fork is to get Linux working with the mGBA debugger, and to get the project template setup with Butano.

Please note that the path to the local Butano clone is hardcoded to ~/deps/butano and may need to be updated in the following files:
* Makefile
